	...
	<body style="background-color: black;">
		...
		<!-- Header -->
			<header id="header">
				<nav>
					...
					<a id="signout" class="hideSign small " href="./includes/logout.php">Sign out</a>
					<a href="#menu">Menu</a>
				</nav>
			</header>
		...
		<nav id="menu">
				<ul class="links">
					...
					<li id="uploadPics"  class="hideSign"><a href="upload.php"><span class="navbarIcons icon fa-upload"></span>Upload Photos</a></li>
		...
		<div class="limiter">
				<div class="container-login100" style="background-image: url('images/zimBackground.jpg');">
					<div class="wrap-login100">
						<form method="POST" action="./includes/login.php" class="login100-form validate-form">

							<h3 >
								Sign in
							</h3>
		
							<div style="margin-bottom:10px;" class="$12u black">
									<input type="text" name="username" id="username" value="" placeholder="Username" required/>
							</div>

							<div style="margin-bottom:10px;" class="$12u black">
									<input type="password" name="pswd" id="pswd" value="" placeholder="Password" required/>
							</div>

							<div class="12u$">
									<input style="width:100%" type="submit" name="signup-submit" value="Sign in" class="special small" />	
							</div>
						</form>
					</div>
				</div>
